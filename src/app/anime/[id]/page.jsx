    ...
    return (
        <>
            ...
            <div className="pt-4 px-4 flex gap-2 text-color-primary overflow-x-auto">
                ...
                <div className="w-60 flex flex-col justify-center items-center rounded border border-color-primary p-2">
                    <h3>RATING</h3>
            ...
            <div className="p-4">
                <h3 className="text-color-primary text-2xl mb-2">The Comments</h3>
